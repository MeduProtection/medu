          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-[#82BE62] lg:border-[#5587B6] mt-6 pt-4 flex flex-col-reverse lg:flex-row justify-between items-center text-center lg:text-start">
              ...
              <div className='lg:hidden flex justify-center gap-[55px] md:gap-[117px] my-2'>
                <Image width={32} height={52} src="/assets/footer/fb.svg" alt="Facebook" className="md:w-[32px] md:h-[52px]" />
                <Image width={52} height={60} src="/assets/footer/ig.svg" alt="IG" className="md:w-[52px] md:h-[60px]" />
                <Image width={56} height={54} src="/assets/footer/phone.svg" alt="Phone" className="md:w-[56px] md:h-[54px]" />
                <Image width={61} height={46} src="/assets/footer/email.svg" alt="Mail" className="md:w-[61px] md:h-[46px]" />
