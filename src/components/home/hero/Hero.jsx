    ...
    <header className=" lg:py-24">
        <div className="container mx-auto flex flex-col items-center">
          <div className="w-full flex flex-col justify-center items-center lg:items-start text-center lg:text-start px-4">
            <h1 className="text-[28px] md:text-[45px] lg:text-[55px] font-bold leading-tight text-[#1B3954]  mb-4">
            ...
            <p className="max-w-sm lg:max-w-full mb-8 font-bold text-[#5587B6] text-[10px] md:text-[17px] lg:text-[21px]">
            See how our revolutionary technology is transforming healthcare.
            </p>
            <button className="text-white bg-[#95BC67] hover:bg-[#059669]  focus:ring-[#059669]  rounded-[40px] text-[14px] md:text-[22px] lg:text-[28px] px-5 py-2.5 text-center lg:w-1/2">
              Get Started Now
            </button>
          ...
          <Savings/>
          <Bar/>
            <img src="/assets/hero/hero.png" alt="Antiviral Gown" className=" w-full md:w-[534px] lg:w-[65%] object-cover " />
          </div>
        </div>
