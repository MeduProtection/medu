    ...
    <header className=" lg:py-24">
        <div className="container mx-auto flex flex-wrap  md:flex-nowrap">
          <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center items-center lg:items-start text-center lg:text-start px-4">
            ...
            <p className="mb-8 font-bold text-[#5587B6] text-[10px] lg:text-[21px]">
            See how our revolutionary technology is transforming healthcare.
            </p>
            <button className="text-white bg-[#95BC67] hover:bg-[#059669]  focus:ring-[#059669]  rounded-[40px] text-[14px] lg:text-[28px] px-5 py-2.5 text-center lg:w-1/2">
              Get Started Now
            </button>
            
          </div>
          <div className="w-full md:w-1/2 lg:w-3/5 px-4 flex justify-center mt-8 lg:mt-0 lg:justify-end items-center relative ">
          <Testimonio/>
          <Savings/>
          <Bar/>
            <img src="/assets/hero/hero.png" alt="Antiviral Gown" className=" w-full lg:w-[65%] object-cover " />
          </div>
        </div>
        <div className='flex justify-center'>
        <p className="mt-4 text-[11px] text-center  lg:text-[21px] text-[#1B3954] font-bold w-[60%] lg:w-full">
