...
function Bar() {
    ...
    return (
        <div className='absolute w-[159px] md:w-[252px] lg:w-[170px] h-[137px] md:h-[217px] lg:h-[140px] xl:w-[252px] xl:h-[200px]  flex flex-col justify-center items-left text-[#1B3954] bg-[rgba(242,247,250,0.50)] shadow-md backdrop-blur-[2px] -bottom-4 lg:bottom-0 left-14 md:left-36 lg:left-auto lg:right-20 rounded-[20px] px-4'>
