...
function Testimonio() {
  return (
    <div className='absolute w-[171px] h-[84px] md:w-[246px] md:h-[121px] flex  justify-between items-center text-[#1B3954] bg-[rgba(242,247,250,0.50)] shadow-md backdrop-blur-[2px]   left-0 md:left-20 top-16 lg:left-0  lg:top-auto lg:bottom-40  rounded-[20px] 2xl'>
