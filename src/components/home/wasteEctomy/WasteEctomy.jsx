    ...
    return (
      <div className="container mx-auto flex flex-wrap  md:flex-nowrap">
        ...
        <div className=" max-w-lg">
            <h2 className="text-[22px] md:text-[37px] md:leading-[37px] lg:text-[50px] font-bold mb-4 text-[#1B3954] text-center lg:text-start ">
              Give your hospital  <br/> a <span className="text-[#4E88B0]"> waste-ectomy.</span>
            </h2>
            <p className="mb-4 lg:mb-8 max-w-md md:max-w-lg text-[10px] md:text-[17px] lg:text-[20px] text-center">
