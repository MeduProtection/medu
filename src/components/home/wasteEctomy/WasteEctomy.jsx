    ...
    return (
      <div className="container mx-auto flex flex-wrap  md:flex-nowrap">
        ...
        <div className=" max-w-lg">
            <h2 className="text-[22px] lg:text-[50px] font-bold mb-4 text-[#1B3954] text-center lg:text-start ">
              Give your hospital  <br/> a <span className="text-[#4E88B0]"> waste-ectomy.</span>
            </h2>
            <p className="mb-4 lg:mb-8 max-w-md text-[10px] lg:text-[20px] text-center">
            ...
            <div className="space-y-4 text-center lg:text-start">
              <p className="text-[12px] lg:text-[16px] font-bold">
                up to <span className="text-[44px] lg:text-[55px] text-green-500 ">80%</span> cost savings
              </p>
              <p className=" text-[12px] lg:text-[16px] font-bold">
                up to <span className="text-[44px] lg:text-[55px] text-blue-500">90%</span> waste reduction
              </p>
              <p className=" text-[12px] lg:text-[16px] font-bold">
