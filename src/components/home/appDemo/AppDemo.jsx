    ...
    <div className="flex flex-col items-center py-12  ">
      <div className='relative'>
        ...
        <ul className='flex flex-col gap-y-2 lg:gap-y-4'>
          <li className='flex gap-2 lg:gap-4'><img className='w-[11px] h-[11px] md:w-[22px] md:h-[22px] 2xl:w-full xl:h-full'  src='/assets/icons/check.svg'/>Check number of washes in real time</li>
          <li className='flex gap-2 lg:gap-4'><img className='w-[11px] h-[11px] md:w-[22px] md:h-[22px] 2xl:w-full xl:h-full'  src='/assets/icons/check.svg'/>Manage Medu gowns and coveralls</li>
          <li className='flex gap-2 lg:gap-4'><img  className='w-[11px] h-[11px] md:w-[22px] md:h-[22px] 2xl:w-full xl:h-full' src='/assets/icons/check.svg'/>Rate quality</li>
        </ul>
        </div>
         
            <img src="/assets/demo/demo.png" alt="App Demo" className="h-[258px] md:h-full lg:h-[550px]" />
            </div>
            <div className="mt-8">
