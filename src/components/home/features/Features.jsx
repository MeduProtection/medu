...
function Features() {
    return (
        <div className="flex flex-col items-center py-12 bg-[#1B3954] text-white">
          <h2 className="text-[21px] font-bold mb-4 text-center text-[#95BC67]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-36 text-center mb-8 mt-8">
            <div>
              ...
              <h3 className="font-semibold text-[20px]">Highest level of user <br/> protection:</h3>
              <p className='text-[20px]' >Level 4 AAMI PB70</p>
            </div>
            <div>
              <div className="bg-[#4E88B0] p-4 rounded-[5px] inline-block mb-2">
                <img src="/assets/features/features.svg" alt="Icon 2" className="h-8 w-8" />
              </div>
              <h3 className="font-semibold text-[20px]">Maximum resistance to <br/> virus penetration:</h3>
              <p className='text-[20px]' >Level 4 AAMI PB70</p>
            </div>
          </div>
          ...
          <div  >
              ...
              <h3 className="font-semibold text-[20px]">Easy disinfection:</h3>
              <p className='text-[20px]' >between washes with integrating existing <br/> laundry systems</p>
            </div>
            <div>
              <div className="bg-[#4E88B0] p-4 rounded-[5px] inline-block mb-2">
                <img src="/assets/features/breathable.svg" alt="Icon 4" className="h-8 w-8" />
              </div>
              <h3 className="font-semibold text-[20px]">Highly breathable</h3>
              <p></p>
            </div>
            <div>
              <div className="bg-[#4E88B0] p-4 rounded-[5px] inline-block mb-2">
              ...
              <h3 className="font-semibold text-[20px]">Excellent water repellency</h3>
              <p className='text-[20px]' >and resistance to liquid <br/> penetration</p>
            </div>
          </div>
          </div>
          <div className="mt-8">
            <button className="bg-[#95BC67]  py-4 px-8 rounded-3xl hover:bg-green-600 transition text-[28px]">
