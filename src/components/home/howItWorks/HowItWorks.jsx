    ...
    return (
      <div className="container mx-auto flex flex-wrap  md:flex-nowrap ">
        <div className="w-full flex flex-col lg:flex-row items-center justify-between py-12 px-4 lg:px-12 bg-white">
          ...
          <div className="lg:w-1/2 flex justify-center lg:justify-end items-center mt-8 lg:mt-0  ">
          ...
          <video
              ...
              controls={true}
            />
          <div className={isPlaying? 'hidden':"absolute inset-0 flex items-center justify-center lg:ml-20 mb-8 lg:mb-0 "}>
