...
function Features() {
  ...
  const textVariants = {
    ...
    return (
        <div ref={ref} className="flex flex-col items-center py-12  text-white">
          ...
          <div className='w-[284px] h-[284px] bg-[#1B3954] rounded-[34px] flex flex-col justify-center items-center' >
            ...
            <div className='w-[284px] h-[284px] bg-[#1B3954] rounded-[34px] flex flex-col justify-center items-center'>
              ...
              <h3 className="font-semibold text-[9px] md:text-[13px] lg:text-[20px]">Highly<br/> breathable</h3>
              <p></p>
            </div>
            <div className='w-[284px] h-[284px] bg-[#1B3954] rounded-[34px] flex flex-col justify-center items-center'>
              <div className=" p-4 rounded-[5px] inline-block mb-2">
